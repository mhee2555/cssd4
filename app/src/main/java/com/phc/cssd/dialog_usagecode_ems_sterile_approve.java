...
public class dialog_usagecode_ems_sterile_approve extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dialog_usagecode_ems_sterile_approve);
        byIntent();
        initialize();
        getlistdata();
    }
    ...
    public void SetIsstatus() {
        class SetIsstatus extends AsyncTask<String, Void, String> {
            private ProgressDialog dialog = new ProgressDialog(dialog_usagecode_ems_sterile_approve.this);
    ...
    public void getlistdata() {
        class getlistdata extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    for(int i=0;i<rs.length();i++){
                        ...
                        adapter = new ListUsageEms(dialog_usagecode_ems_sterile_approve.this,Model_RQ);
            ...
            protected String doInBackground(String... params) {
                ...
                String result = null;
                try {
                    result = httpConnect.sendPostRequest(Url.URL + "cssd_check_usage_ems_dialog_sterile_approve.php", data);
                    Log.d("KJDGDK",data+"");
                    Log.d("KJDGDK",result);
                }catch(Exception e){
                    e.printStackTrace();
