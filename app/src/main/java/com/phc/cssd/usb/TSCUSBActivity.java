...
public class TSCUSBActivity extends Activity implements Runnable {
            ...
            if ("com.android.example.USB_PERMISSION".equals(action)) {
                synchronized(this) {
                    ...
                    if (intent.getBooleanExtra("permission", false) && device != null) {
                        com.phc.cssd.usb.TSCUSBActivity.hasPermissionToCommunicate = true;
                    }
                }
            }
    ...
    private final BroadcastReceiver mUsbReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if ("com.android.example.USB_PERMISSION".equals(action)) {
                synchronized(this) {
                    com.phc.cssd.usb.TSCUSBActivity.this.mUsbDevice = (UsbDevice)intent.getParcelableExtra("device");
                    if (intent.getBooleanExtra("permission", false)) {
                        if (com.phc.cssd.usb.TSCUSBActivity.this.mUsbDevice != null) {
                            com.phc.cssd.usb.TSCUSBActivity.this.mopen();
                        }
                    } else {
                        Log.d("ERROR", "permission denied for device " + com.phc.cssd.usb.TSCUSBActivity.this.device);
                    }
                }
            }
...
//        this.openbtn.setOnClickListener(new OnClickListener() {
//            public void onClick(View v) {
//                com.phc.cssd_4_sd.usb.TSCUSBActivity.this.openport(com.phc.cssd_4_sd.usb.TSCUSBActivity.this.mUsbManager, com.phc.cssd_4_sd.usb.TSCUSBActivity.this.device);
//                String data = com.phc.cssd_4_sd.usb.TSCUSBActivity.this.sendcommand_getstring("OUT GETSETTING$(\"SYSTEM\", \"INFORMATION\", \"MODEL\")");
//                com.phc.cssd_4_sd.usb.TSCUSBActivity.this.label1.setText(data);
//            }
//        });
//        this.sendbtn = (Button)this.findViewById(2131230722);
//        this.sendbtn.setOnClickListener(new OnClickListener() {
//            public void onClick(View v) {
//                com.phc.cssd_4_sd.usb.TSCUSBActivity.this.sendbythread();
//            }
//        });
//        this.mopenbtn = (Button)this.findViewById(2131230723);
//        this.mopenbtn.setOnClickListener(new OnClickListener() {
//            public void onClick(View v) {
//                com.phc.cssd_4_sd.usb.TSCUSBActivity.this.closeport();
//            }
//        });
    }
    ...
    public void threadopen() {
        Thread thread = new Thread(new Runnable() {
            @SuppressLint("WrongConstant")
            public void run() {
                com.phc.cssd.usb.TSCUSBActivity.this.mUsbManager = (UsbManager) com.phc.cssd.usb.TSCUSBActivity.this.getSystemService("usb");
                com.phc.cssd.usb.TSCUSBActivity.this.mUsbDevice = (UsbDevice) com.phc.cssd.usb.TSCUSBActivity.this.getIntent().getParcelableExtra("device");
                com.phc.cssd.usb.TSCUSBActivity.this.mUsbIntf = com.phc.cssd.usb.TSCUSBActivity.this.mUsbDevice.getInterface(0);
                com.phc.cssd.usb.TSCUSBActivity.mUsbendpoint = com.phc.cssd.usb.TSCUSBActivity.this.mUsbIntf.getEndpoint(0);
                com.phc.cssd.usb.TSCUSBActivity.mUsbConnection = com.phc.cssd.usb.TSCUSBActivity.this.mUsbManager.openDevice(com.phc.cssd.usb.TSCUSBActivity.this.mUsbDevice);
                com.phc.cssd.usb.TSCUSBActivity.mUsbConnection.claimInterface(com.phc.cssd.usb.TSCUSBActivity.this.mUsbIntf, true);

                for(int i = 0; i < com.phc.cssd.usb.TSCUSBActivity.this.mUsbIntf.getEndpointCount(); ++i) {
                    UsbEndpoint end = com.phc.cssd.usb.TSCUSBActivity.this.mUsbIntf.getEndpoint(i);
                    if (end.getDirection() == 128) {
                        com.phc.cssd.usb.TSCUSBActivity.usbEndpointIn = end;
                    } else {
                        com.phc.cssd.usb.TSCUSBActivity.usbEndpointOut = end;
                    }
                }

                String printercommand = "FEED 100\n";
                byte[] command = printercommand.getBytes();
                com.phc.cssd.usb.TSCUSBActivity.mUsbConnection.bulkTransfer(com.phc.cssd.usb.TSCUSBActivity.mUsbendpoint, command, command.length, com.phc.cssd.usb.TSCUSBActivity.this.TIMEOUT);
            }
        });
        thread.start();
    }
    ...
    private void sendbythread() {
        Thread thread = new Thread(new Runnable() {
            public void run() {
                ...
                com.phc.cssd.usb.TSCUSBActivity.mUsbConnection.bulkTransfer(com.phc.cssd.usb.TSCUSBActivity.mUsbendpoint, command, command.length, com.phc.cssd.usb.TSCUSBActivity.this.TIMEOUT);
                com.phc.cssd.usb.TSCUSBActivity.mUsbConnection.bulkTransfer(com.phc.cssd.usb.TSCUSBActivity.mUsbendpoint, command2, command2.length, com.phc.cssd.usb.TSCUSBActivity.this.TIMEOUT);
            }
        });
        thread.start();
        this.USBReceive();
        ...
        Thread ReceiveThread = new Thread(new Runnable() {
            public void run() {
                ...
                if (mRunning) {
                    ...
                    int timeoutMillis = 100;
                    //int readAmt = true;
                    int length = com.phc.cssd.usb.TSCUSBActivity.mUsbConnection.bulkTransfer(com.phc.cssd.usb.TSCUSBActivity.usbEndpointIn, dest, dest.length, timeoutMillis);
                    if (length > 0) {
                        com.phc.cssd.usb.TSCUSBActivity.this.response = 0;
                        com.phc.cssd.usb.TSCUSBActivity.this.receivelength = length;

                        for(int i = 0; i < com.phc.cssd.usb.TSCUSBActivity.this.receivelength - 1; ++i) {
                            com.phc.cssd.usb.TSCUSBActivity.this.strIN.append((char)dest[i]);
                        }
                    } else {
                        com.phc.cssd.usb.TSCUSBActivity.this.response = 1;
                    }
                }
            ...
            public void run() {
                ...
                while(mRunning) {
                    ...
                    if (length > 0) {
                        ...
                        while(true) {
                            if (i >= com.phc.cssd.usb.TSCUSBActivity.this.receivelength - 1) {
                                continue label29;
                            }
        ...
        if (mUsbConnection == null) {
            ...
            Thread thread = new Thread(new Runnable() {
                public void run() {
                    ...
                    com.phc.cssd.usb.TSCUSBActivity.mUsbConnection.bulkTransfer(com.phc.cssd.usb.TSCUSBActivity.mUsbendpoint, msgBuffer, msgBuffer.length, com.phc.cssd.usb.TSCUSBActivity.this.TIMEOUT);
                }
            });
            thread.start();
        ...
        if (mUsbConnection == null) {
            ...
            Thread thread = new Thread(new Runnable() {
                public void run() {
                    ...
                    for(int i = 0; i <= length; i += com.phc.cssd.usb.TSCUSBActivity.this.MAX_USBFS_BUFFER_SIZE) {
                        int remain_data = length - i;
                        if (remain_data < com.phc.cssd.usb.TSCUSBActivity.this.MAX_USBFS_BUFFER_SIZE && i != 0) {
                            com.phc.cssd.usb.TSCUSBActivity.mUsbConnection.bulkTransfer(com.phc.cssd.usb.TSCUSBActivity.mUsbendpoint, command, i, remain_data, com.phc.cssd.usb.TSCUSBActivity.this.TIMEOUT);
                        } else {
                            com.phc.cssd.usb.TSCUSBActivity.mUsbConnection.bulkTransfer(com.phc.cssd.usb.TSCUSBActivity.mUsbendpoint, command, i, com.phc.cssd.usb.TSCUSBActivity.this.MAX_USBFS_BUFFER_SIZE, com.phc.cssd.usb.TSCUSBActivity.this.TIMEOUT);
                        }
                    }
            ...
            Thread ReceiveThread = new Thread(new Runnable() {
                public void run() {
                    ...
                    if (mRunning) {
                        ...
                        int timeoutMillis = 100;
                        //int readAmt = true;
                        int length = com.phc.cssd.usb.TSCUSBActivity.mUsbConnection.bulkTransfer(com.phc.cssd.usb.TSCUSBActivity.usbEndpointIn, com.phc.cssd.usb.TSCUSBActivity.this.readBuf, com.phc.cssd.usb.TSCUSBActivity.this.readBuf.length, timeoutMillis);
                        if (length <= 0) {
                            com.phc.cssd.usb.TSCUSBActivity.this.response = 1;
                            com.phc.cssd.usb.TSCUSBActivity.this.readBuf[0] = -1;
                        }
                    }
                ...
                public void run() {
                    ...
                    if (mRunning) {
                        ...
                        if (length > 0) {
                            ...
                            for(int i = 0; i < com.phc.cssd.usb.TSCUSBActivity.this.receivelength - 1; ++i) {
                                com.phc.cssd.usb.TSCUSBActivity.this.strIN.append((char) com.phc.cssd.usb.TSCUSBActivity.this.readBuf[i]);
                            }
                        } else {
                            com.phc.cssd.usb.TSCUSBActivity.this.response = 1;
                        }
