...
public class RR_itemstock_Adapter extends ArrayAdapter {
    ...
    public RR_itemstock_Adapter(Activity aActivity, ArrayList<Response_Aux_itemstock> listData, ListView Lv2) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tFields2.setText( listData.get(position).getxFields14()==null?"หมายเหตุ : -":"หมายเหตุ : "+listData.get(position).getxFields14() );
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Lv2.setAdapter(new RR_itemstock_Adapter(context, listData,Lv2));
            }
        });
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Button button5 = (Button) dialog.findViewById(R.id.button2);
