...
public class Aux3Adapter extends ArrayAdapter {
    private ArrayList<Response_Aux> listData ;
    private Context context;

    public Aux3Adapter(AppCompatActivity aActivity, ArrayList<Response_Aux> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View v = inflater.inflate(R.layout.list_aux3, parent, false);
