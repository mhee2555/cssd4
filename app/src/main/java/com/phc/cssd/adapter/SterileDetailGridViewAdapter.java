...
public class SterileDetailGridViewAdapter extends ArrayAdapter<ModelSterileDetail> {
    ...
    public SterileDetailGridViewAdapter(Activity context, List<ModelSterileDetail> DATA_MODEL, boolean IsActive,String B_ID) {
        super(context, R.layout.activity_grid_sterile_detail_data, DATA_MODEL);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflator.inflate(R.layout.activity_grid_sterile_detail_data, null);
