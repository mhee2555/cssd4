...
public class Aux5Adapter_Previewstricker extends ArrayAdapter {
    private ArrayList<Response_Aux> listData ;
    private Context context;

    public Aux5Adapter_Previewstricker(AppCompatActivity aActivity, ArrayList<Response_Aux> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View v = inflater.inflate(R.layout.list_aux5_previewsticker, parent, false);
