...
public class Aux5ChkboxAdapter extends ArrayAdapter {
    private ArrayList<Response_Aux> listData ;
    private Context context;

    public Aux5ChkboxAdapter(AppCompatActivity aActivity, ArrayList<Response_Aux> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View v = inflater.inflate(R.layout.list_aux5chk, parent, false);
        ...
        tFields3.setVisibility(View.INVISIBLE);
        ...
        if( listData.get(position).getFields7().equals("1") ){
