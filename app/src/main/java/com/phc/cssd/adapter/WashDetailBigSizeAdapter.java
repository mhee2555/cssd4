...
public class WashDetailBigSizeAdapter extends ArrayAdapter<ModelWashDetail> {

    private final List<ModelWashDetail> DATA_MODEL;
    private final Activity context;
    private final boolean IsActive;

    public WashDetailBigSizeAdapter(Activity context, List<ModelWashDetail> DATA_MODEL, boolean IsActive) {
        super(context, R.layout.activity_list_big_size_wash_detail, DATA_MODEL);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflator.inflate(R.layout.activity_list_big_size_wash_detail, null);
