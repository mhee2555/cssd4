    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                String IsCancel = "0";
                if(chkUpdate) {
                    setData("1",tName.getText()+"",IsCancel,tId.getText()+"",iFt.setUrlUnit());
                    ListData(tName.getText()+"");
                }else {

                    setData("0",tName.getText()+"",IsCancel,tId.getText()+"",iFt.setUrlUnit());
                    ListData("%");
            ...
            public void onClick(View v) {
                if (!tId.getText().toString().equals("")) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        builder = new AlertDialog.Builder(UnitsActivity.this, android.R.style.Theme_Material_Dialog_Alert);
                    } else {
                        builder = new AlertDialog.Builder(UnitsActivity.this);
                    }
                    builder.setTitle("การลบข้อมูลของคุณ อาจมีผลกระทบกับหลายส่วนของโปรแกรม")
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    setData("2",tName.getText()+"","1",tId.getText()+"",iFt.setUrlUnit());
                                    ListData("%");
                                    toggleChange();
                                }
                            })
    ...
    public void ListData(String Search) {
        class ListData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(UnitsActivity.this, "Please Wait",null, true, true);
            }
            @Override
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    lv1.setAdapter(new Aux2Adapter( UnitsActivity.this, results));
            ...
            protected String doInBackground(String... params) {
                ...
                String result = ruc.sendPostRequest(iFt.getUrlUnit(),data);
                return  result;
            }
        }
