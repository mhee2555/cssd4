...
public class ItemTypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("ประเภทรายการ");
        getSupportActionBar().hide();

        setContentView(R.layout.setting_item_type);
        ...
        btSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                String xIsCancel = "0";
                if(chkUpdate) {
                    setData("1",tName.getText()+"",xIsCancel,tId.getText()+"",iFt.setUrlItemType());
                    ListData(tName.getText()+"");
                }else {
                    setData("0",tName.getText()+"",xIsCancel,tId.getText()+"",iFt.setUrlItemType());
                    ListData("%");
                }
                chkUpdate=false;
                toggleChange();
        ...
        btDel.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    builder = new AlertDialog.Builder(ItemTypeActivity.this, android.R.style.Theme_Material_Dialog_Alert);
                } else {
                    builder = new AlertDialog.Builder(ItemTypeActivity.this);
                }
                builder.setTitle("การลบข้อมูลของคุณ อาจมีผลกระทบกับหลายส่วนของโปรแกรม")
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                setData("2", tName.getText() + "", "1", tId.getText() + "", iFt.setUrlItemType());
                                ListData("%");
                                toggleChange();
                            }
                        })
    ...
    public void ListData(String Search) {
        class ListData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ItemTypeActivity.this, "Please Wait",null, true, true);
            }
            @Override
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    lv1.setAdapter(new Aux2Adapter( ItemTypeActivity.this, results));
            ...
            protected String doInBackground(String... params) {
                ...
                String result = ruc.sendPostRequest(iFt.getUrlItemType(),data);
                return  result;
            }
        }
