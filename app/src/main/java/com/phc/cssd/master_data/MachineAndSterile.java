...
public class MachineAndSterile extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine_and_sterile);
    ...
    private void toggleCheckboxAll_link(Boolean temp) {
        ...
        lv1.setAdapter(new AuxSterileProgramItem( MachineAndSterile.this, ArrayProgram));
    }
                ...
                try {
                    ...
                    for(int i=0;i<setRs.length();i++){
                        ...
                        if(c.getString("bool").equals("true")){
                            Toast.makeText(MachineAndSterile.this, "ผูกสำเร็จ", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(MachineAndSterile.this, "ผูกล้มเหลว", Toast.LENGTH_SHORT).show();
                        }
                    }
