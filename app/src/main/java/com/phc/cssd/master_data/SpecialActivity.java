...
public class SpecialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.setting_special);
        ...
        btSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                String IsCancel = "0";
                if(chkUpdate) {
                    setData("1",tName.getText()+"",IsCancel,tId.getText()+"",iFt.setUrlSpecial());
                    ListData(tName.getText()+"");
                }else {

                    setData("0",tName.getText()+"",IsCancel,tId.getText()+"",iFt.setUrlSpecial());
                    ListData("%");
            ...
            public void onClick(View v) {
                if (!tId.getText().toString().equals("")) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        builder = new AlertDialog.Builder(SpecialActivity.this, android.R.style.Theme_Material_Dialog_Alert);
                    } else {
                        builder = new AlertDialog.Builder(SpecialActivity.this);
                    }
                    builder.setTitle("การลบข้อมูลของคุณ อาจมีผลกระทบกับหลายส่วนของโปรแกรม")
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    setData("2",tName.getText()+"","1",tId.getText()+"",iFt.setUrlSpecial());
                                    ListData("%");
                                    toggleChange();
                                }
                            })
    ...
    public void ListData(String Search) {
        class ListData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(SpecialActivity.this, "Please Wait",null, true, true);
            }
            @Override
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    lv1.setAdapter(new Aux2Adapter( SpecialActivity.this, results));
            ...
            protected String doInBackground(String... params) {
                ...
                String result = ruc.sendPostRequest(iFt.getUrlSpecial(),data);
                return  result;
            }
        }
