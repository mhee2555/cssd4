...
public class PackingmapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.setting_packingmap);
        setTitle("PackingMat");
        getSupportActionBar().hide();

        tId = (TextView) findViewById(R.id.tId);
        tPackingmat = (EditText) findViewById(R.id.editPackingmat);
        tShelf = (EditText) findViewById(R.id.editShelf);
        ...
        btSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                String IsCancel = "0";
                if(chkUpdate) {
                    setData("1",tId.getText()+"",tPackingmat.getText()+"",tShelf.getText()+"",IsCancel,iFt.setUrlPackingmat());
                    ListData(tPackingmat.getText()+"");
                }else {

                    setData("0",tId.getText()+"",tPackingmat.getText()+"",tShelf.getText()+"",IsCancel,iFt.setUrlPackingmat());
                    ListData("%");
            ...
            public void onClick(View v) {
                if (!tId.getText().toString().equals("")) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        builder = new AlertDialog.Builder(PackingmapActivity.this, android.R.style.Theme_Material_Dialog_Alert);
                    } else {
                        builder = new AlertDialog.Builder(PackingmapActivity.this);
                    }
                    builder.setTitle("การลบข้อมูลของคุณ อาจมีผลกระทบกับหลายส่วนของโปรแกรม")
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    setData("2",tId.getText()+"",tPackingmat.getText()+"",tShelf.getText()+"","1",iFt.setUrlPackingmat());
                                    ListData("%");
                                    toggleChange();
                                }
                            })
    ...
    public void ListData(String Search) {
        class ListData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(PackingmapActivity.this, "Please Wait",null, true, true);
            }
            @Override
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    for(int i=0;i<setRs.length();i++){
                        ...
                        newsData.setFields2(c.getString("xPackingmat"));
                        newsData.setFields3(c.getString("xShelf"));
                        newsData.setFields4(c.getString("xIsCancel"));
                        results.add( newsData );
                    }
                    final ListView lv1 = (ListView) findViewById(R.id.listView);
                    lv1.setAdapter(new Aux3Adapter( PackingmapActivity.this, results));
                    ...
                    lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                            ...
                            tPackingmat.setText(newsData.getFields2());
                            tShelf.setText(newsData.getFields3());
                            chkUpdate = true;
                            toggleChange();
            ...
            protected String doInBackground(String... params) {
                ...
                String result = ruc.sendPostRequest(iFt.getUrlPackingmat(),data);
                return  result;
            }
        }
    ...
    public void setData(String sel,String xId,String xPackingmat,String xShelf,String xIsCancel,String xUrl) {
        class ListData extends AsyncTask<String, Void, String> {
            ProgressDialog loading;
            @Override
            protected void onPreExecute() {
            ...
            protected String doInBackground(String... params) {
                ...
                data.put("xPackingmat",params[2]);
                data.put("xShelf",params[3]);
        ...
        ListData ru = new ListData();
        ru.execute( sel,xId,xPackingmat,xShelf,xIsCancel,xUrl );
    }
