    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                String IsCancel = "0";
                if(chkUpdate) {
                    setData("1",tName.getText()+"",IsCancel,tId.getText()+"",iFt.setUrlSupplier());
                    ListData(tName.getText()+"");
                }else {
                    setData("0",tName.getText()+"",IsCancel,tId.getText()+"",iFt.setUrlSupplier());
                    ListData("%");
                }
                chkUpdate=false;
            }
            ...
            public void onClick(View v) {
                if (!tId.getText().toString().equals("")) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        builder = new AlertDialog.Builder(SupplierActivity.this, android.R.style.Theme_Material_Dialog_Alert);
                    } else {
                        builder = new AlertDialog.Builder(SupplierActivity.this);
                    }
                    builder.setTitle("การลบข้อมูลของคุณ อาจมีผลกระทบกับหลายส่วนของโปรแกรม")
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    setData("2", tName.getText() + "", "1", tId.getText() + "", iFt.setUrlSupplier());
                                    ListData("%");
                                    toggleChange();
                                }
                            })
    ...
    public void ListData(String Search) {
        class ListData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(SupplierActivity.this, "Please Wait",null, true, true);
            }
            @Override
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    lv1.setAdapter(new AuxAdapter( SupplierActivity.this, results));
            ...
            protected String doInBackground(String... params) {
                ...
                String result = ruc.sendPostRequest(iFt.getUrlSupplier(),data);
                return  result;
            }
        }
