...
import com.phc.cssd.adapter.MasterData3Adapter;
...
public class MasterData_3Field extends Activity {
    ...
    private EditText edit_value_1;

    private TextView txt_name;
    private TextView txt_column_name;
    private TextView txt_value_1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_master_data_3_field);
    ...
    private void byWidget(){
        ...
        edit_value_1 = (EditText) findViewById(R.id.edit_value_1);
        ...
        txt_value_1 = (TextView) findViewById(R.id.txt_value_1);

        // Master Label
        if(Table.equals(Cons.PACKING)){
            ColumnName = Cons.PACKING_TYPE_NAME;
        }

        txt_name.setText(ColumnName);
        txt_column_name.setText(ColumnName);
        txt_value_1.setText("อายุ");
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BackgroundWorker backgroundWorker = new BackgroundWorker(MasterData_3Field.this);
                backgroundWorker.execute("save", ID, (IsNew ? "1" : "0" ), edt_code.getText().toString(), edt_name.getText().toString(), edit_value_1.getText().toString());
            }
        });
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder adb = new AlertDialog.Builder(MasterData_3Field.this);
        ...
        ListData.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String value_1 = ((TextView)((LinearLayout) view).getChildAt(2)).getText().toString();

                edt_code.setText(value);
                edt_name.setText(data);
                edit_value_1.setText(value_1);
    ...
    public class BackgroundWorker extends AsyncTask<String,Void,String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(MasterData_3Field.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if(type.equals("delete")) {
                ...
                url_ = Url.URL + "cssd_save_master_3.php";
            }else if(type.equals("display")) {
                url_ = Url.URL + "cssd_display_master_3.php";
            }else{
                return null;
            }
        ...
        protected void onPostExecute(String result) {
            ...
            if(Success && data != null) {
                ...
                if(TYPE.equals("display")){
                    try {
                        ArrayAdapter<ModelMasterData> adapter = new MasterData3Adapter(MasterData_3Field.this, getModel());
        ...
        private ModelMasterData get(int index, String code, String name, String value1 ) {
