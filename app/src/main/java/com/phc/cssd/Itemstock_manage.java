...
import com.phc.cssd.adapter.AuxAdapter_itemstock;
...
public class Itemstock_manage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_itemstock_manage);
        setTitle("Item Stock");
        ...
        button_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!qty.getText().toString().equals("") && !item_name.getText().toString().equals("") && !item_code.getText().toString().equals("") && !usage_code.getText().toString().equals("")) {
                    ...
                    Toast.makeText(Itemstock_manage.this,"กรุณากรอกข้อมูลให้ถูกต้อง", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        button_change_dept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!getCountselected().equals("0")) {
                    ...
                    Toast.makeText(Itemstock_manage.this,"กรุณาเลือกข้อมูลอย่างน้อย 1 รายการ", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    for(int i=0;i<setRs.length();i++){
                        ...
                        newsData.setxFields10(c.getString("xItem_Code"));
                        ArrayData.add( newsData );
                    }
                    list_data.setAdapter(new AuxAdapter_itemstock( Itemstock_manage.this, ArrayData));
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if(item.getTitle().equals("ลบข้อมูล")){
            AlertDialog.Builder builder = new AlertDialog.Builder(Itemstock_manage.this);
    ...
    public void OnDeleteSelected(int index){
        ...
        ChangeStatus(newsData.getFields1(),newsData.getxFields10(),newsData.getFields8());
        ListData(Item_Code);
    }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    for(int i=0;i<setRs.length();i++){
                        JSONObject c = setRs.getJSONObject(i);
                        if(c.getString("bool").equals("true")){
                            Toast.makeText(Itemstock_manage.this,"เปลี่ยนสถานะสำเร็จ", Toast.LENGTH_LONG).show();
                        }else{
                            Toast.makeText(Itemstock_manage.this,"เปลี่ยนสถานะล้มเหลว", Toast.LENGTH_LONG).show();
                        }
                    }
        ...
        class SpinnerData extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(Itemstock_manage.this,android.R.layout.simple_spinner_dropdown_item,SpinnerArr);
                ...
                try {
                    ...
                    for(int i=0;i<setRs.length();i++){
                        ...
                        if(c.getString("bool").equals("true")){
                            ...
                            qty.setText("");
                            dept.setSelection(0);
                            Toast.makeText(Itemstock_manage.this, "เพิ่มข้อมูลสำเร็จ", Toast.LENGTH_LONG).show();
                        }else{
                            Toast.makeText(Itemstock_manage.this, "เพิ่มข้อมูลล้มเหลว", Toast.LENGTH_LONG).show();
                        }
                    }
                ...
                try {
                    ...
                    for(int i=0;i<setRs.length();i++){
                        ...
                        if(c.getString("bool").equals("true")){
                            ...
                            qty.setText("");
                            dept.setSelection(0);
                            Toast.makeText(Itemstock_manage.this, "เปลี่ยนแผนกสำเร็จ", Toast.LENGTH_LONG).show();
                        }else{
                            Toast.makeText(Itemstock_manage.this, "เปลี่ยนแผนกล้มเหลว", Toast.LENGTH_LONG).show();
                        }
                    }
