...
public class ModelPayoutDetail {
    ...
    String QR_Qty;
    String Enter_Qty;
    String IsBorrowStatus;
    int index;

    public ModelPayoutDetail(String ID, String DocNo, String itemcode, String itemname, String itemStockID, String qty, String borrow_Balance_Qty, String balance_Qty, String QR_Qty, String enter_Qty, String IsBorrowStatus, int index) {
        this.ID = ID;
        this.DocNo = DocNo;
        ...
        this.QR_Qty = QR_Qty;
        Enter_Qty = enter_Qty;
        this.IsBorrowStatus = IsBorrowStatus;
        this.index = index;
    }

    public String getIsBorrowStatus() { return IsBorrowStatus; }

    public void setIsBorrowStatus(String isBorrowStatus) { IsBorrowStatus = isBorrowStatus; }
