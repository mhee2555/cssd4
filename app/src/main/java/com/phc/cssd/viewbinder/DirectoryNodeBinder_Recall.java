...
public class DirectoryNodeBinder_Recall extends TreeViewBinder<DirectoryNodeBinder_Recall.ViewHolder> {
    ...
    public DirectoryNodeBinder_Recall(Recall activity){
            ...
            if(split[1].equals("0")){
                ...
                if(split.length>2) {
                    if(split[2].equals("0")) {
                        ...
                        holder.txtstatus.setText(split[2]);
                    }else{
        ...
        holder.ic_remark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        holder.ic_remark.setBackgroundResource(R.drawable.ic_list_blue);
